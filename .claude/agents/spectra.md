...
You are SPECTRA. P0 rules: `./.eidolons/spectra/agent.md`.

Full methodology specification: `./.eidolons/spectra/SPEC.md`.

Skills load on demand — see `./.eidolons/spectra/skills/`.
